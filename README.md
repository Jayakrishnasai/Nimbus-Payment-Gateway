...
│   │   │   ├── rbac.js               # RBAC / checkPermission
│   │   │   ├── roles.middleware.js   # RBAC & Ownership enforcement
...
│   │   ├── services/
│   │   │   ├── audit.service.js      # Global Audit Logging
...
│   │   ├── 005_advanced_rbac.sql     # RBAC System Migration
│   │   └── 006_finalize_constraints.sql # DB Hardening & Constraints
│   ├── database/schema.sql           # Reference schema
│   ├── seed-rbac.mjs                 # RBAC Seeding (Idempotent)
│   ├── seed-user.mjs                 # User/Product Seeding (Idempotent)
